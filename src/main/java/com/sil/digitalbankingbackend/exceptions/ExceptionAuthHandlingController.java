...
public class ExceptionAuthHandlingController {
    ...
    public ResponseEntity<Object> handleNoHandlerFound(NoHandlerFoundException ex, WebRequest request) {
        return new ResponseEntity<>(
                new Response(HttpStatus.NOT_FOUND, false, "Application cannot reach to server",
    ...
    public ResponseEntity<Object> handleUserNotFoundException(UsernameNotFoundException ex) {
        return new ResponseEntity<>(
                new Response(HttpStatus.NOT_FOUND, false, "User not found", ex.getLocalizedMessage()),
                HttpStatus.NOT_FOUND
        );
    }
    ...
    public ResponseEntity<Object> handleGeneralException(Exception ex) {
        return new ResponseEntity<>(
                new Response(HttpStatus.INTERNAL_SERVER_ERROR, false, "Internal server error", ex.getLocalizedMessage()),
